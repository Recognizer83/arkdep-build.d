...
echo 'password\n' | arch-chroot $workdir sudo -S -u aur paru -Syy --noconfirm wezterm-git ironbar-git bluetuith-bin mmtui-bin calcure xdg-desktop-portal-termfilechooser-hunkyburrito-git quich ncpamixer wl-clipboard-rs
