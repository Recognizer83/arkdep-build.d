...
echo 'password\n' | arch-chroot $workdir sudo -S -u aur paru -Syy --noconfirm wezterm-nightly-bin eww-git bluetuith-bin mmtui-bin calcure xdg-desktop-portal-termfilechooser-hunkyburrito-git wiremix-git wl-clipboard-rs
